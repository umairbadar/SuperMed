...
public class Fragment_Cat_Product extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_cat_products, container, false);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (status){
                                ...
                                Main_Apps.hud.dismiss();
                                /*Toast.makeText(getContext(), "No Product Found",

...
public class Fragment_Sub_Sub_Cat_Product extends Fragment {

    View view;

    private String slug, sub_slug, main_slug;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_sub_sub_cat_products, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null){
            ...
            main_slug = getArguments().getString("main_slug");
        }
        //Toast.makeText(getContext(), main_slug + " " + sub_slug + " " + slug, Toast.LENGTH_LONG).show();
        ...
        getProducts(main_slug, sub_slug, slug, currentPage);
    ...
    private void getProducts(final String main_slug, final String sub_slug, final String slug, final int limit){
        Main_Apps.hud.show();
        ...
        StringRequest req = new StringRequest(Request.Method.POST, URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("cateSlug", main_slug);
                map.put("subcateSlug", sub_slug);
                map.put("childCateSlug", slug);

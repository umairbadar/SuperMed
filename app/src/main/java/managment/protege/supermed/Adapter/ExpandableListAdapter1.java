...
public class ExpandableListAdapter1 extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (childPosition == 0){
            txtListChild.setCompoundDrawablesWithIntrinsicBounds( R.drawable.ic_marker, 0, 0, 0);
        } else if (childPosition == 1){
            txtListChild.setCompoundDrawablesWithIntrinsicBounds( R.drawable.ic_call, 0, 0, 0);
        }else if (childPosition == 2){
            txtListChild.setCompoundDrawablesWithIntrinsicBounds( R.drawable.ic_whatsapp, 0, 0, 0);
        }else if (childPosition == 3){
            txtListChild.setCompoundDrawablesWithIntrinsicBounds( R.drawable.ic_email, 0, 0, 0);
        }else if (childPosition == 4){
            txtListChild.setCompoundDrawablesWithIntrinsicBounds( R.drawable.ic_time, 0, 0, 0);
        }
